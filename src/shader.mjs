export default {
    vertex: `#version 300 es
        ...
        `,
    anime4k_deblur_dog_frag: `precision highp float;
    ...
    splitRGB_frag: `#version 300 es
        ...
        `,
    Anime4K_3DGraphics_AA_Upscale_x2_US_frag1: `#version 300 es
        precision highp float;
        in vec2 vTextureCoord;
        uniform vec4 inputSize;
        uniform sampler2D uSampler;
        ...
        `,
    Anime4K_3DGraphics_AA_Upscale_x2_US_frag2: `#version 300 es
        precision highp float;
        in vec2 vTextureCoord;
        uniform vec4 inputSize;
        uniform sampler2D uSampler;
        ...
        `,
    Anime4K_3DGraphics_AA_Upscale_x2_US_frag3: `#version 300 es
        precision highp float;
        in vec2 vTextureCoord;
        uniform vec4 inputSize;
        uniform sampler2D uSampler;
        ...
        `,
    Anime4K_3DGraphics_AA_Upscale_x2_US_frag4: `#version 300 es
        precision highp float;
        in vec2 vTextureCoord;
        uniform vec4 inputSize;
        uniform sampler2D uSampler;
